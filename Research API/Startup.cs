...
namespace Research_API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<Content_DBContext>(options => options.UseSqlServer("Server=.\\SQLEXPRESS;Database=Pizza_DB;Trusted_Connection=True; MultipleActiveResultSets=true"));
